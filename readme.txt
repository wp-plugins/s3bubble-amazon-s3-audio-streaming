=== S3Bubble Amazon S3 Video And Audio Streaming Service With Cloudfront ===
...
**Media Elements JS Video Single Player Shortcode Example.**
`[s3bubbleMediaElementVideo bucket="enter-your-bucket" track="enter-your-track-name"]`

**Media Elements JS Audio Single Player Shortcode Example.**
`[s3bubbleMediaElementAudio bucket="enter-your-bucket" track="enter-your-track-name"]`
...
S3Bubble costs from $7.99 p/month plus the costs of your hosting with Amazon S3 (detailed below). For this you get an unbranded player, unlimited media streaming and all the back end tools to manage your files.
