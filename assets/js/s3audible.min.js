	...
	e(function() {
		e(".s3audible").each(function(t) {
			...
			var g = new jPlayerPlaylist({
				...
				ready : function(n) {
					var u = {
						action : "s3bubble_plugin_audio_playlist_api",
						username : r,
						email : i,
						bucket : s,
						folder : o,
				...
				swfPath : "https://isdcloud.s3.amazonaws.com/s3bubbleplayer/Jplayer.swf",
				supplied : "mp3,m4a",
				cssSelector : {
					play : ".s3-play",
					pause : ".s3-pause",
		...
		e(".s3video").each(function(t) {
			...
			var E = "https://isdcloud.s3.amazonaws.com/ajax_loaders/712.GIF";
			e(this).html('<div id="s3-container-video-' + t + '" class="s3-playlist-wrapper"><div class="s3-type-playlist jp-jplayer"><div class="s3-contain"><img class="s3bubble-loading" src="' + E + '"/><div class="s3-video-play"><a href="javascript:;" class="s3-video-play-icon" tabindex="1"><i class="s3icon-play"></i></a></div><div id="s3-jplayer-video-' + t + '" class="s3-jplayer videoPoster"></div></div><div class="s3-gui s3-gui-video"><div class="s3-interface"><ul class="s3-controls"><li><a href="javascript:;" class="s3-previous" tabindex="1"><i class="s3icon-backward"></i></a></li><li><a href="javascript:;" class="s3-play" tabindex="1"><i class="s3icon-play"></i></a></li><li><a href="javascript:;" class="s3-pause" tabindex="1"><i class="s3icon-pause"></i></a></li><li><a href="javascript:;" class="s3-next" tabindex="1"><i class="s3icon-forward"></i></a></li></ul><div class="s3-time-container"><div class="s3-current-time"></div><div class="s3-time-seperator">/</div><div class="s3-duration"></div></div><div class="s3bubble-rail"><div class="s3-progress"><div class="s3-seek-bar"><div class="s3-play-bar"></div></div></div></div><ul class="s3-toggles"><li><a href="javascript:;" class="s3-playlist-hide' + t + '" tabindex="1"><i class="s3icon-list"></i></a></li><li><a href="javascript:;" class="s3-mute" tabindex="1" title="mute"><i class="s3icon-volume-up"></i></a></li><li><a href="javascript:;" class="s3-unmute" tabindex="1" title="unmute"><i class="s3icon-volume-off"></i></a></li><li><a href="javascript:;" class="s3-full-screen" tabindex="1"><i class="s3icon-resize-full"></i></a></li><li><a href="javascript:;" class="s3-restore-screen" tabindex="1" style="display: block;"><i class="s3icon-resize-small"></i></a></li><li><a href="javascript:;" class="s3-shuffle-off" tabindex="1" title="shuffle off"><i class="s3icon-random"></i></a></li><li><a href="javascript:;" data-snum="' + t + '" class="search-tracks" tabindex="1"><i class="s3icon-search"></i></a></li></ul></div></div><div class="s3search s3audible-search-' + t + '" style="display:none;"><input type="text" id="s3bubble-video-playlist-tsearch-' + t + '" class="s3bubble-video-playlist-tsearch" name="s3bubble-video-playlist-tsearch" placeholder="Search"></div><div class="s3-playlist s3bubble-video-playlist-tracksearch-' + t + '" style="display:' + y + ';"><ul><li class="list-fix"></li></ul></div><div class="s3-no-solution" style="display:none;"><span>Update Required</span>To play the media you will need to either update your browser to a recent version or update your <a href="https://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.</div></div></div><a href="https://s3bubble.com/branding" title="S3Bubble Cloud Media Streaming" class="s3-poweredby" target="_blank">Powered by S3Bubble Cloud Media Streaming</a>');
			if (e(this).width() < 580) {
			...
			var S = new jPlayerPlaylist({
				...
				ready : function(n) {
					...
					e.post("https://s3bubble.com/wp-admin/admin-ajax.php", u, function(n) {
						...
						if (isFirefox) {
						    var _player_canvas = document.getElementById("s3-jplayer-video-single-" + t);
						    function mousMove () {
						        e('.s3-gui').fadeIn();
						        document.getElementById("s3-jplayer-video-single-" + t).removeEventListener( 'mousemove', mousMove, true);
						        setTimeout(function(){
						        	addlistenerGui();
						        }, 5000);
						    } 
						    function addlistenerGui() {
						    	e('.s3-gui').fadeOut();
						        document.getElementById("s3-jplayer-video-single-" + t).addEventListener( 'mousemove', mousMove, true);
						    }
						    addlistenerGui();
						}
					}, "json")
