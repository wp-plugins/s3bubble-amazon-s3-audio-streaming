	...
	e(function() {
		...
		e(".s3video").each(function(t) {
			...
			var S = new jPlayerPlaylist({
				...
				ready : function(n) {
					var u = {
						action : "plugin_video_api_cloudfront",
						username : r,
						email : i,
						bucket : s,
						folder : o,
		...
		e(".s3videoSingle").each(function(t) {
			...
			var S = new jPlayerPlaylist({
				...
				ready : function(n) {
					var u = {
						action : "single_video_api_cloudfront",
						username : r,
						email : i,
						bucket : s,
						track : o,
