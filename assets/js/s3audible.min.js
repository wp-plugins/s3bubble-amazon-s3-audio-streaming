(function(e, t) {
	...
	e.fn.jPlayer = function(n) {
		var r = "string" === typeof n, i = Array.prototype.slice.call(arguments, 1), s = this;
		n = !r && i.length ? e.extend.apply(null, [!0, n].concat(i)) : n;
		if (r && "_" === n.charAt(0))
			return s;
		r ? this.each(function() {
			var r = e(this).data("jPlayer"), o = r && e.isFunction(r[n]) ? r[n].apply(r, i) : r;
			if (o !== r && o !== t)
				return s = o, !1
		}) : this.each(function() {
	...
	e.jPlayer.event = {};
	e.each("ready flashreset resize repeat click error warning loadstart progress suspend abort emptied stalled play pause loadedmetadata loadeddata waiting playing canplay canplaythrough seeking seeked timeupdate ended ratechange durationchange volumechange".split(" "), function() {
		e.jPlayer.event[this] = "jPlayer_" + this
	});
	e.jPlayer.htmlEvent = "loadstart abort emptied stalled loadedmetadata loadeddata canplay canplaythrough".split(" ");
	...
	n.prototype = {
		...
		time : function(e) {
			var t = new Date(1e3 * (e && "number" === typeof e ? e : 0)), n = t.getUTCHours();
			e = this.options.timeFormat.showHour ? t.getUTCMinutes() : t.getUTCMinutes() + 60 * n;
			t = this.options.timeFormat.showMin ? t.getUTCSeconds() : t.getUTCSeconds() + 60 * e;
			n = this.options.timeFormat.padHour && 10 > n ? "0" + n : n;
			e = this.options.timeFormat.padMin && 10 > e ? "0" + e : e;
			t = this.options.timeFormat.padSec && 10 > t ? "0" + t : t;
			n = "" + (this.options.timeFormat.showHour ? n + this.options.timeFormat.sepHour : "");
			n += this.options.timeFormat.showMin ? e + this.options.timeFormat.sepMin : "";
			return n += this.options.timeFormat.showSec ? t + this.options.timeFormat.sepSec : ""
		}
	};
	var r = new n;
	...
	e.jPlayer.uaBrowser = function(e) {
		e = e.toLowerCase();
		var t = /(opera)(?:.*version)?[ \/]([\w.]+)/, n = /(msie) ([\w.]+)/, r = /(mozilla)(?:.*? rv:([\w.]+))?/;
		e = /(webkit)[ \/]([\w.]+)/.exec(e) || t.exec(e) || n.exec(e) || 0 > e.indexOf("compatible") && r.exec(e) || [];
		return {
			browser : e[1] || "",
			version : e[2] || "0"
		}
	...
	e.jPlayer.uaPlatform = function(e) {
		var t = e.toLowerCase(), n = /(android)/, r = /(mobile)/;
		e = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/.exec(t) || [];
		t = /(ipad|playbook)/.exec(t) || !r.exec(t) && n.exec(t) || [];
		e[1] && (e[1] = e[1].replace(/\s/g, "_"));
		return {
			platform : e[1] || "",
			tablet : t[1] || ""
		}
	...
	i = e.jPlayer.uaPlatform(navigator.userAgent);
	i.platform && (e.jPlayer.platform[i.platform] = !0, e.jPlayer.platform.mobile = !i.tablet, e.jPlayer.platform.tablet = !!i.tablet);
	e.jPlayer.getDocMode = function() {
		var t;
		e.jPlayer.browser.msie && (document.documentMode ? t = document.documentMode : ( t = 5, document.compatMode && "CSS1Compat" === document.compatMode && ( t = 7)));
		return t
	};
	e.jPlayer.browser.documentMode = e.jPlayer.getDocMode();
	e.jPlayer.nativeFeatures = {
		init : function() {
			var e = document, t = e.createElement("video"), n = {
			...
			}, r = ["w3c", "moz", "webkit", "webkitVideo"], i, s;
			this.fullscreen = t = {
				support : {
					w3c : !!e[n.w3c[0]],
					moz : !!e[n.moz[0]],
	...
	var s = function(t) {
		...
		n && (e.each(e.jPlayer.keyIgnoreElementNames.split(/\s+/g), function(e, n) {
			...
			if (i && t.which === i.key && e.isFunction(i.fn))
				return t.preventDefault(), i.fn(n), !1
		}))
	};
	e.jPlayer.keys = function(t) {
		e(document.documentElement).unbind("keydown.jPlayer");
		t && e(document.documentElement).bind("keydown.jPlayer", s)
	};
	e.jPlayer.keys(!0);
	e.jPlayer.prototype = {
		count : 0,
		...
		_init : function() {
			...
			this.options = this.require.video ? e.extend(!0, {}, this.optionsVideo, this.options) : e.extend(!0, {}, this.optionsAudio, this.options);
			this._setSize();
			...
			e.each(this.solutions, function(t, r) {
				if (0 === t)
					...
					var i = !1, s = !1;
					e.each(n.formats, function(e, t) {
						n[n.solutions[0]].canPlay[t] && ("video" === n.format[t].media ? s = !0 : i = !0)
					});
			...
			if (this.flash.used) {
				...
				if (e.jPlayer.browser.msie && (9 > Number(e.jPlayer.browser.version) || 9 > e.jPlayer.browser.documentMode)) {
					...
					r = document.createElement('<object id="' + this.internal.flash.id + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="0" height="0" tabindex="-1"></object>');
					for (var s = 0; s < i.length; s++)
						r.appendChild(document.createElement(i[s]))
				} else
					s = function(e, t, n) {
						...
						e.appendChild(r)
					}, r = document.createElement("object"), r.setAttribute("id", this.internal.flash.id), r.setAttribute("name", this.internal.flash.id), r.setAttribute("data", this.internal.flash.swf), r.setAttribute("type", "application/x-shockwave-flash"), r.setAttribute("width", "1"), r.setAttribute("height", "1"), r.setAttribute("tabindex", "-1"), s(r, "flashvars", i), s(r, "allowscriptaccess", "always"), s(r, "bgcolor", this.options.backgroundColor), s(r, "wmode", this.options.wmode);
		...
		_testPlaybackRate : function(e) {
			e = document.createElement("string" === typeof e ? e : "audio");
			try {
				return "playbackRate" in e ? (e.playbackRate = .5, .5 === e.playbackRate) : !1
			} catch(t) {
				return !1
			}
		},
		...
		_addHtmlEventListeners : function(t, n) {
			...
			this.status.playbackRateEnabled && (t.defaultPlaybackRate = this.options.defaultPlaybackRate, t.playbackRate = this.options.playbackRate);
			t.addEventListener("progress", function() {
				n.gate && (r.internal.cmdsIgnored && 0 < this.readyState && (r.internal.cmdsIgnored = !1), r._getHtmlStatus(t), r._updateInterface(), r._trigger(e.jPlayer.event.progress))
			}, !1);
		...
		_getHtmlStatus : function(e, t) {
			...
			n = e.currentTime;
			r = 0 < this.status.duration ? 100 * n / this.status.duration : 0;
			"object" === typeof e.seekable && 0 < e.seekable.length ? ( i = 0 < this.status.duration ? 100 * e.seekable.end(e.seekable.length - 1) / this.status.duration : 100, s = 0 < this.status.duration ? 100 * e.currentTime / e.seekable.end(e.seekable.length - 1) : 0) : ( i = 100, s = r);
			t && ( r = s = n = 0);
		...
		_trigger : function(t, n, r) {
			t = e.Event(t);
			t.jPlayer = {};
			t.jPlayer.version = e.extend({}, this.version);
			t.jPlayer.options = e.extend(!0, {}, this.options);
			t.jPlayer.status = e.extend(!0, {}, this.status);
			t.jPlayer.html = e.extend(!0, {}, this.html);
			t.jPlayer.flash = e.extend(!0, {}, this.flash);
			n && (t.jPlayer.error = e.extend({}, n));
			r && (t.jPlayer.warning = e.extend({}, r));
			...
			if (t === e.jPlayer.event.ready)
				if (!this.internal.ready)
					...
					if (this.status.srcSet) {
						var r = this.status.currentTime, i = this.status.paused;
						this.setMedia(this.status.media);
						this.volumeWorker(this.options.volume);
						0 < r && ( i ? this.pause(r) : this.play(r))
					}
		...
		play : function(e) {
			...
			this.status.srcSet ? (this.focus(), this.html.active ? this._html_play(e) : this.flash.active && this._flash_play(e)) : this._urlNotSetError("play")
		},
		videoPlay : function() {
			this.play()
		},
		...
		tellOthers : function(t, n) {
			var r = this, i = "function" === typeof n, s = Array.prototype.slice.call(arguments);
			"string" === typeof t && (i && s.splice(1, 1), e.each(this.instances, function() {
		...
		mutedWorker : function(t) {
			...
			this.html.video.gate || this.html.audio.gate || (this._updateMute(t), this._updateVolume(this.options.volume), this._trigger(e.jPlayer.event.volumechange))
		},
		mute : function(e) {
			e = e === t ? !0 : !!e;
			this._muted(e)
		...
		_updateMute : function(e) {
			...
			this.css.jq.mute.length && this.css.jq.unmute.length && (this.status.noVolume ? (this.css.jq.mute.hide(), this.css.jq.unmute.hide()) : e ? (this.css.jq.mute.hide(), this.css.jq.unmute.show()) : (this.css.jq.mute.show(), this.css.jq.unmute.hide()))
		},
		volume : function(e) {
			this.volumeWorker(e);
		...
		volumeWorker : function(t) {
			...
			this.html.video.gate || this.html.audio.gate || (this._updateVolume(t), this._trigger(e.jPlayer.event.volumechange))
		},
		volumeBar : function(t) {
			if (this.css.jq.volumeBar.length) {
				var n = e(t.currentTarget), r = n.offset(), i = t.pageX - r.left, s = n.width();
				t = n.height() - t.pageY + r.top;
				n = n.height();
				this.options.verticalVolume ? this.volume(t / n) : this.volume(i / s)
			}
		...
		_cssSelector : function(t, n) {
			var r = this;
			"string" === typeof n ? e.jPlayer.prototype.options.cssSelector[t] ? (this.css.jq[t] && this.css.jq[t].length && this.css.jq[t].unbind(".jPlayer"), this.options.cssSelector[t] = n, this.css.cs[t] = this.options.cssSelectorAncestor + " " + n, this.css.jq[t] = n ? e(this.css.cs[t]) : [], this.css.jq[t].length && this.css.jq[t].bind("click.jPlayer", function(n) {
				n.preventDefault();
				r[t](n);
				e(this).blur()
		...
		seekBar : function(t) {
			if (this.css.jq.seekBar.length) {
				var n = e(t.currentTarget), r = n.offset();
				t = t.pageX - r.left;
				n = n.width();
				this.playHead(100 * t / n)
			}
		},
		playBar : function() {
		},
		...
		playbackRateBar : function(t) {
			if (this.css.jq.playbackRateBar.length) {
				...
				t = n.height() - t.pageY + r.top;
				n = n.height();
				this.playbackRate((this.options.verticalPlaybackRate ? t / n : i / s) * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate)
			}
		},
		...
		option : function(n, r) {
			...
			if ("string" === typeof n) {
				var s = n.split(".");
				if (r === t) {
					for (var i = e.extend(!0, {}, this.options), o = 0; o < s.length; o++)
						if (i[s[o]] !== t)
							i = i[s[o]];
						else
				...
				for (var o = i = {}, u = 0; u < s.length; u++)
					u < s.length - 1 ? (o[s[u]] = {}, o = o[s[u]]) : o[s[u]] = r
			}
			this._setOptions(i);
			return this
		},
		...
		_setOption : function(t, n) {
			...
			switch(t) {
				...
				case"fullScreen":
					if (this.options[t] !== n) {
						...
						if (!i || i && !this.status.waitForPlay)
							i || (this.options[t] = n), n ? this._requestFullscreen() : this._exitFullscreen(), i || this._setOption("fullWindow", n)
					}
					break;
				case"fullWindow":
				...
				case"noVolume":
					...
					break;
				case"emulateHtml":
					this.options[t] !== n && ((this.options[t] = n) ? this._emulateHtmlBridge() : this._destroyHtmlBridge());
					break;
				case"timeFormat":
					this.options[t] = e.extend({}, this.options[t], n);
					break;
		...
		_requestFullscreen : function() {
			var t = this.ancestorJq.length ? this.ancestorJq[0] : this.element[0], n = e.jPlayer.nativeFeatures.fullscreen;
			n.used.webkitVideo && ( t = this.htmlElement.video);
			n.api.fullscreenEnabled && n.api.requestFullscreen(t)
		},
		_exitFullscreen : function() {
			var t = e.jPlayer.nativeFeatures.fullscreen, n;
		...
		_html_pause : function(e) {
			var t = this, n = this.htmlElement.media;
			0 < e ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId);
			n.pause();
			if (!isNaN(e))
				try {
					if (!n.seekable || "object" === typeof n.seekable && 0 < n.seekable.length)
		...
		_html_playHead : function(e) {
			...
			try {
				...
				else if (0 < n.duration && !isNaN(n.duration))
		...
		_alert : function(e) {
			e = "jPlayer " + this.version.script + " : id='" + this.internal.self.id + "' : " + e;
			this.options.consoleAlerts ? console && console.log && console.log(e) : alert(e)
		},
		...
		_destroyHtmlBridge : function() {
			...
			e.each((e.jPlayer.emulateMethods + " " + e.jPlayer.emulateStatus + " " + e.jPlayer.emulateOptions).split(/\s+/g), function(e, n) {
...
(function(e, t) {
	jPlayerPlaylist = function(t, n, r) {
		...
		this.options = e.extend(!0, {}, this._options, r);
		this.playlist = [];
		this.original = [];
		this._initPlaylist(n);
		this.cssSelector.title = this.cssSelector.cssSelectorAncestor + " .s3-title";
		this.cssSelector.playlist = this.cssSelector.cssSelectorAncestor + " .s3-playlist";
		this.cssSelector.next = this.cssSelector.cssSelectorAncestor + " .s3-next";
		this.cssSelector.previous = this.cssSelector.cssSelectorAncestor + " .s3-previous";
		this.cssSelector.shuffle = this.cssSelector.cssSelectorAncestor + " .s3-shuffle";
		this.cssSelector.shuffleOff = this.cssSelector.cssSelectorAncestor + " .s3-shuffle-off";
	...
	jPlayerPlaylist.prototype = {
		...
		_options : {
			playlistOptions : {
				...
				removeTime : "fast",
				shuffleTime : "slow",
				itemClass : "s3-playlist-item",
				freeGroupClass : "s3-free-media",
				freeItemClass : "s3-playlist-item-free",
				removeItemClass : "s3-playlist-item-remove"
			}
		},
		option : function(e, n) {
			if (n === t)
		...
		_refresh : function(t) {
			var n = this;
			if (t && !e.isFunction(t))
				e(this.cssSelector.playlist + " ul").empty(), e.each(this.playlist, function(t) {
				...
				e(this.cssSelector.playlist + " ul").slideUp(r, function() {
					...
					n._updateControls();
					e.isFunction(t) && t();
					n.playlist.length ? e(this).slideDown(n.options.playlistOptions.displayTime) : e(this).show()
				})
			}
		},
		_createListItem : function(t) {
			var n = this, r = "<li><div>";
			r += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>Ã—</a>";
			if (t.free) {
				var i = !0;
			...
			var s = null;
			if (this.options.playlistOptions.share && this.options.playlistOptions.download === false) {
				s = "5px"
			}
			var o = t.title.replace(/-/gi, " ").replace(/_/gi, " ").replace(/PROCESSED/g, "");
			r += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + this.textLimit(o, this.options.playlistOptions.playerWidth < 300 ? 15 : 100) + (t.artist ? " <span class='s3-artist'>by " + t.artist + "</span>" : "") + "</a>";
			r += "</div>" + (this.options.playlistOptions.share ? '<a style="right:' + s + '" class="s3bubble_share" target="_blank" href="' + t.key + '"><i class="s3icon-twitter"></i></a>' : "") + "" + (this.options.playlistOptions.download ? '<a class="download" target="_self" href="' + t.download + '" title="' + o + '"><i class="s3icon-cloud-download"></i></a>' : "") + "</li>";
			return r
		},
		_createItemHandlers : function() {
			var t = this;
			e(this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass).die("click").live("click", function() {
				var n = e(this).parent().parent().index();
				t.current !== n ? t.play(n) : e(t.cssSelector.jPlayer).jPlayer("play");
				e(this).blur();
				return !1
			});
			e(t.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass).die("click").live("click", function() {
				e(this).parent().parent().find("." + t.options.playlistOptions.itemClass).click();
				e(this).blur();
				return !1
			});
			e(t.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass).die("click").live("click", function() {
				var n = e(this).parent().parent().index();
				t.remove(n);
				e(this).blur();
				return !1
		...
		add : function(t, n) {
			...
			n ? this.play(this.playlist.length - 1) : this.original.length === 1 && this.select(0)
		},
		remove : function(n) {
			var r = this;
			if (n === t)
				...
				if (0 <= n && n < this.playlist.length)
					this.removing = !0, e(this.cssSelector.playlist + " li:nth-child(" + (n + 1) + ")").slideUp(this.options.playlistOptions.removeTime, function() {
						e(this).remove();
						if (r.shuffled) {
							var t = r.playlist[n];
							e.each(r.original, function(e) {
								if (r.original[e] === t)
									return r.original.splice(e, 1), !1
							})
						} else
		...
		next : function() {
			...
			this.loop ? e === 0 && this.shuffled && this.options.playlistOptions.shuffleOnLoop && this.playlist.length > 1 ? this.shuffle(!0, !0) : this.play(e) : e > 0 && this.play(e)
		},
		previous : function() {
...
(function(e) {
	e(function() {
		e(".s3audible").each(function(t) {
			var n = base64.decode(e(this).data("userdata")).split("|");
			var r = n[0];
			var i = n[1];
			var s = e(this).data("bucket");
			var o = e(this).data("folder");
			var u = e(this).data("download");
			var a = e(this).data("search");
			var f = e(this).data("height");
			var l = e(this).data("playlist");
			var c = e(this).data("s3hare");
			var h = e(this).data("order");
			var p = e(this).data("solution");
			var d = e(this).data("preload");
			var v = "metadata";
			if (d === "none") {
				v = "none"
			}
			var m = e(this).data("cloudfront");
			var g = "mp3,m4a";
			if (m) {
				g = "rtmpa";
				v = "none";
			...
			var w = new jPlayerPlaylist({
				...
				playlistOptions : {
					...
					download : u,
					share : c,
					playerWidth : e(this).width(),
					enableRemoveControls : false
				},
				ready : function(n) {
					var u = {
						action : "s3bubble_plugin_audio_playlist_api_check",
						username : r,
						cloudfront : m,
						email : i,
						bucket : s,
					...
					e.post("https://s3bubble.com/wp-admin/admin-ajax.php", u, function(n) {
						e(".s3-playlist-loader").fadeOut();
						if (n.user === "not_paid") {
						...
						w.setPlaylist(n);
						if (f) {
							e(".s3audible .s3bubble-audio-playlist-tracksearch-" + t).css({
								height : f,
								"overflow-y" : "scroll"
							})
						}
						e(".s3audible .s3-playlist-hide" + t).click(function() {
							e(".s3audible .s3bubble-audio-playlist-tracksearch-" + t).slideToggle();
							return false
						});
						e(".s3audible .search-tracks").click(function() {
							if (e(".s3audible .s3audible-search-" + t).hasClass("searchOpen")) {
								e(".s3audible .s3audible-search-" + t).fadeOut().removeClass("searchOpen")
							} else {
								e(".s3audible .s3audible-search-" + t).fadeIn().addClass("searchOpen")
							}
							return false
						});
						e(".s3audible #s3bubble-audio-playlist-tsearch-" + t).keyup(function() {
							if (e(this).val() != "") {
								e(".s3audible .s3bubble-audio-playlist-tracksearch-" + t + " ul li").hide();
								e(".s3audible .s3bubble-audio-playlist-tracksearch-" + t + " ul li div:contains('" + e(this).val() + "')").parent("li").show()
							} else {
								e(".s3audible .s3bubble-audio-playlist-tracksearch-" + t + " ul li").show()
							}
						});
						e(".s3audible .s3bubble_share").click(function() {
							var t = e(this).attr("href");
							var n = {
								action : "create_share_id_app",
								bucket : s,
								folder : o,
								username : r,
								name : t
							};
							e.post("https://s3bubble.com/wp-admin/admin-ajax.php", n, function(e) {
								window.open("https://twitter.com/share?url=http://s3bubble.com/share/?file=" + e + "&text=" + t + " Audio Shared Via @S3Bubble", "_blank")
							}, "json");
							return false
						})
					}, "json")
		...
		e(".s3audibleSingle").each(function(t) {
			var n = base64.decode(e(this).data("userdata")).split("|");
			var r = n[0];
			var i = n[1];
			var s = e(this).data("bucket");
			var o = e(this).data("track");
			var u = e(this).data("download");
			var a = e(this).data("height");
			var f = e(this).data("s3hare");
			var l = e(this).data("autoplay");
			var c = e(this).data("style");
			var h = e(this).data("preload");
			var p = "metadata";
			if (h === "none") {
				p = "none"
			}
			var d = e(this).data("cloudfront");
			var v = "mp3,m4a";
			if (d) {
				v = "rtmpa";
				p = "none";
			...
			var g = new jPlayerPlaylist({
				...
				ready : function(n) {
					...
					e.post("https://s3bubble.com/wp-admin/admin-ajax.php", a, function(n) {
						if (n.user === "not_paid") {
							alert("Alert unfortunately your S3Bubble free trial has expired please upgrade to continue using S3Bubble and remove this message.")
						}
						if (u === true) {
							e("#s3-single-container-" + t + " .s3-gui .s3-toggles").append('<li><a target="_self" href="' + n[0].download + '" class="s3-cloud-download" tabindex="1" style="display: block;"><i class="s3icon-cloud-download"></i></a></li>')
						}
						if (f === true) {
							e("#s3-single-container-" + t + " .s3-gui .s3-toggles").append('<li><a class="s3bubble_share" target="_blank" href="' + n[0].key + '"><i class="s3icon-twitter"></i></a></li>')
						}
						g.setPlaylist(n);
						if (c === "plain") {
							e("#s3-single-container-" + t).css({
								overflow : "hidden",
								height : "40px"
							})
						}
						e(".s3bubble_share").click(function() {
							var t = e(this).attr("href");
							var n = {
								action : "create_share_id_app",
								bucket : s,
		...
		e(".s3video").each(function(t) {
			...
			var u = e(this).data("download");
			var a = e(this).data("search");
			var f = e(this).data("responsive");
			var l = e(this).data("height");
			var c = e(this).data("playlist");
			var h = e(this).data("s3hare");
			var p = e(this).data("order");
			var d = e(this).data("solution");
			var v = e(this).data("cloudfront");
			var m = "m4v";
			if (v) {
				m = "rtmpv";
				if (navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry)/)) {
			...
			if (f === "270p") {
				...
				var i = parseInt(Math.round(e(this).width()));
				i *= 1;
			...
			var E = new jPlayerPlaylist({
				...
				ready : function(n) {
					var u = {
						action : "s3bubble_plugin_video_playlist_api",
						username : r,
						email : i,
						bucket : s,
						folder : o,
					...
					e.post("https://s3bubble.com/wp-admin/admin-ajax.php", u, function(n) {
						...
						if (l) {
							e(".s3video .s3bubble-video-playlist-tracksearch-" + t).css({
								height : l,
								"overflow-y" : "scroll"
							})
						}
						e(".s3video .s3-playlist ul li a").click(function() {
							e(".s3bubble-loading").fadeIn()
						});
						e(".s3video .s3bubble_share").click(function() {
							var t = e(this).attr("href");
							var n = {
								action : "create_video_id_app",
								username : r,
								bucket : s,
								folder : o,
								name : t
							...
							e.post("https://s3bubble.com/wp-admin/admin-ajax.php", n, function(e) {
								window.open("https://twitter.com/share?url=http://s3bubble.com/watch/?v=" + e[0].code + "&text=" + t + " Video Shared Via @S3Bubble", "_blank")
							}, "json");
							return false
						});
						e(".s3video .s3-playlist-hide" + t).click(function() {
							e(".s3video .s3bubble-video-playlist-tracksearch-" + t).slideToggle();
							return false
						});
						e(".s3video .search-tracks").click(function() {
							if (e(".s3video .s3audible-search-" + t).hasClass("searchOpen")) {
								e(".s3video .s3audible-search-" + t).fadeOut().removeClass("searchOpen")
							} else {
								e(".s3video .s3audible-search-" + t).fadeIn().addClass("searchOpen")
							}
							return false
						});
						e("#s3bubble-video-playlist-tsearch-" + t).keyup(function() {
							if (e(this).val() != "") {
								e(".s3bubble-video-playlist-tracksearch-" + t + " ul li").hide();
								e(".s3bubble-video-playlist-tracksearch-" + t + " ul li div:contains('" + e(this).val() + "')").parent("li").show()
							} else {
								e(".s3bubble-video-playlist-tracksearch-" + t + " ul li").show()
							}
						})
					}, "json")
				},
		...
		e(".s3videoSingle").each(function(t) {
			var n = base64.decode(e(this).data("userdata")).split("|");
			var r = n[0];
			var i = n[1];
			var s = e(this).data("bucket");
			...
			var E = new jPlayerPlaylist({
				...
				ready : function(n) {
					var a = {
						action : "s3bubble_plugin_video_single_api_test",
						username : r,
						email : i,
						bucket : s,
						track : o,
					...
					e.post("https://s3bubble.com/wp-admin/admin-ajax.php", a, function(n) {
						...
						if (u === true) {
							e("#s3-container-video-single-" + t + " .s3-gui .s3-toggles").append('<li><a  target="_self" href="' + n[0].download + '" class="s3-cloud-download" tabindex="1" style="display: block;"><i class="s3icon-cloud-download"></i></a></li>')
						}
						if (h === true) {
							e("#s3-container-video-single-" + t + " .s3-gui .s3-toggles").append('<li><a class="s3bubble_share" target="_blank" href="' + n[0].key + '"><i class="s3icon-twitter"></i></a></li>')
						}
						E.setPlaylist(n);
						e("video").bind("contextmenu", function(e) {
							return false
						});
						e(".s3videoSingle .s3-playlist ul li a").click(function() {
							e(".s3bubble-loading").fadeIn()
						});
						e(".s3videoSingle .s3bubble_share").click(function() {
							var t = e(this).attr("href");
							var n = {
								action : "create_video_id_app",
								username : r,
						...
						if (i) {
							var o = document.getElementById("s3-jplayer-video-single-" + t);
							function a() {
								e(".s3-gui").fadeIn();
								document.getElementById("s3-jplayer-video-single-" + t).removeEventListener("mousemove", a, true);
								setTimeout(function() {
									f()
								}, 5e3)
							}
							...
							function f() {
								e(".s3-gui").fadeOut();
								document.getElementById("s3-jplayer-video-single-" + t).addEventListener("mousemove", a, true)
							}
	...
	e.expr[":"].contains = e.expr.createPseudo(function(t) {
		return function(n) {
